...
(
    ...
    ./main.py $CROPTS dos_init -r 0.05

    ./main.py $CROPTS -c 1 -f ../e-state-county/cvr-1000--20-200.csv -F ../e-state-county/manifest-1-1000.csv county_setup
    ./main.py $CROPTS -c 2 -f ../e-state-county/cvr-10--0--2-4-1.csv -F ../e-state-county/manifest-2-10.csv county_setup
    ./main.py $CROPTS -c 3 -f ../e-state-county/cvr-100--2-24-40.csv -F ../e-state-county/manifest-3-100.csv county_setup

    echo -e "\nFinish 'Define audit' step to select contests, enter the random seed, and Launch the Audit\n"

    ./main.py $CROPTS -C 0 -C 1 -C 4 -C 5 -s 12341234123412341234 dos_start
...
(
    ...
    ./main.py $CROPTS -c 1 -p '1 100' -R 1 county_audit
    ./main.py $CROPTS -c 2 -p '-1 100' -R 1 county_audit
    ./main.py $CROPTS -c 3 -p '-1 100' -R 1 county_audit
